...
function URL_Search_RAWG(search) {
    return "https://api.rawg.io/api/games?key=7465f1c4b11d465898232c5155c4d607&page_size=24&search="+search;
}

function URL_Genres_RAWG(genre) {
    return "https://api.rawg.io/api/games?key=7465f1c4b11d465898232c5155c4d607&page_size=24&genres="+genre;
}
...
function URL_Platform_RAWG(platform) {
    ...
    return "https://api.rawg.io/api/games?key=7465f1c4b11d465898232c5155c4d607&page_size=24&platforms="+platform;
}
